...
namespace API_For_TCG_Card_Shop_Simulator.Patches
{
    ...
    public class GetMonsterDataRelatedPatches
    {
        ...
        public static bool GetCardFameAmount(ModdedCardData cardData)
        {
            ...
            {
                int num = 1;
                ERarity rarity = InventoryBasePatches.DataHandlers.GetTetramonData(cardData.tetramonType).Rarity;
